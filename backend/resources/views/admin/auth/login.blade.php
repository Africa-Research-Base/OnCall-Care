        ...
        <form method="POST" action="{{ route('admin.login.submit') }}" class="space-y-4">
            ...
            <div>
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus
                    class="w-full border border-slate-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-slate-500" />
            </div>
            ...
            <button type="submit"
                class="w-full bg-slate-800 text-white py-2 rounded-md font-semibold hover:bg-slate-700 transition">
                Sign In
            </button>
        </form>
    </div>
